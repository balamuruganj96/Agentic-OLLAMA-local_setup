...
schema_write_file={
          ...
          "function": {
              "name": "write_file",
              "description": "Overwrites an existing file or writes to a new file if it doesn't exists(and creates required parent dirs safely).constrained to the current working directory",
              "parameters": {
                  "type": "object",
                  "properties": {
                      "file_path": {
